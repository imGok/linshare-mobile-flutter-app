...
class LinShareHttpClient {
  ...
  Future<AccountQuotaResponse> findQuota(QuotaId quotaUuid) async {
    final accountQuotaJson = await _dioClient.get(Endpoint.quota.withPathParameter(quotaUuid.uuid).generateEndpointPath());

    return AccountQuotaResponse.fromJson(accountQuotaJson);
  }
}
